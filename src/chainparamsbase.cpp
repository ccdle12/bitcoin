...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    gArgs.AddArg("-privnet", "Private network. ", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const std::string& chain)
{
    ...
    else if (chain == CBaseChainParams::PRIVNET)
	return MakeUnique<CBaseChainParams>("privnet", 18444);
    else
